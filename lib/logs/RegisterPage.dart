// ignore_for_file: file_names, non_constant_identifier_names, use_build_context_synchronously, avoid_print, prefer_const_constructors, use_key_in_widget_constructors, duplicate_import, unused_import, library_private_types_in_public_api, deprecated_member_use
import 'dart:math';
  ...
  void signUserUp() async {
    ...
    try {
      ...
      if (passwordController.text == ConfirmPasswordController.text) {
        ...
        print(
            '             this is ecode:pass wrong                 000000000000000000000000000');
        //pop the loading circle
        Navigator.pop(context);
      }
